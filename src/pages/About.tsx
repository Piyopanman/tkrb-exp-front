  ...
  return (
    <div className="about-container">
      ...
      <p>
        ...
        <br />
        とうらぶ練度チェッカーは、共に過ごしてきた刀剣男士たちの成長を振り返りたいという思いと他刃に追いつくために根平糖を頬張ったり厚樫山周回したりする刀剣男士の２次創作を見たいという下心から作られたサービスです。
        <br />
        ぜひ皆さまも自分の本丸の男士と共に過ごした軌跡を振り返ってみてください。
        <br />
        また、調査結果の「厚樫山○周分」についてですが、こちらは対象の男士が隊長で誉なし・1回の出陣で5回の戦闘を行った際に得られる経験値（900
        * 5）で算出しております。
        <br />
